 ...
 * des:
 */
public class Read_MonthQueryFragment extends BaseFragment implements IQueryFragment, XRefreshView.XRefreshViewListener, DialogInterface.OnDismissListener {
    ...
    public Read_MonthQueryFragment() {
    }

    public static Read_MonthQueryFragment newInstance(String type) {
        Read_MonthQueryFragment fragment = new Read_MonthQueryFragment();
    ...
    protected void startGetArgument(Bundle savedInstanceState) {
        ...
        presenter = new Read_QueryPresenter(this, "月度");
    ...
    public void onRefresh() {
        pageIndex=0;
        presenter.getData(0,buildingId, "月度", startDate, meterType, ++pageIndex, pageSize);
    }

    @Override
    public void onLoadMore(boolean isSilence) {
        presenter.getData(1,buildingId, "月度", startDate, meterType, ++pageIndex, pageSize);
    }
